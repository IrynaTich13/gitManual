...
Для того, чтобы понять отличается ли наш текущий файл от уже сохранённого - используем команду `git diff`. После введения этой команды мы сможем увидеть: удалённые строки, добавленные строки и статистику измененеий. 
