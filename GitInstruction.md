...
git checkout -b <имя новой ветки> - сразу перенесёт нас в соданную новую ветку
git switch <имя новой ветки> - работает в новых версиях Git
git switch -c <имя новой ветки> - работает в новых версиях Git и сразу переносит во вновь созданную ветку