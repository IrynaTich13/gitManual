...
`git checkout -b <имя новой ветки>` - создаёт новую ветку и сразу в неё  (*работает в новых версиях Git*)

`git switch <имя новой ветки>` - создаёт новую ветку (*работает в новых версиях Git*)

`git switch -c <имя новой ветки>` - создаёт новую ветку и сразу в неё  (*работает в новых версиях Git*)
