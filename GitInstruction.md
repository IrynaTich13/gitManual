...
Таким образом с помощью этой команды мы фиксируем (сохраняем) текущее состояние нашего файла. Для удобства поиска в дальнейшем всех изменений мы указываем комментарий к каждому сохранению. Для этого к команде мы добавляем `-m` и текст в кавычках, с помощью которого потом мы поймём что именно было зафиксировано на этом этапе. 
